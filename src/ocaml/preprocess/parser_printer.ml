...
let print_symbol = function
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_strict_function_type) -> "strict_function_type"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_reversed_separated_nonempty_llist_STAR_atomic_type_gbl_) -> "reversed_separated_nonempty_llist_STAR_atomic_type_gbl_"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_option_layout_attr_) -> "option_layout_attr_"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_mk_longident_mod_ext_longident___anonymous_46_) -> "mk_longident_mod_ext_longident___anonymous_46_"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_local_strict_binding) -> "local_strict_binding"
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_local_fun_binding) -> "local_fun_binding"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_layout_string) -> "layout_string"
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_layout_attr) -> "layout_attr"
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_layout_annotation) -> "layout_annotation"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.N MenhirInterpreter.N_include_maybe_functor) -> "include_maybe_functor"
...
let print_value (type a) : a MenhirInterpreter.symbol -> a -> string = function
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_strict_function_type -> (fun _ -> "strict_function_type")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_reversed_separated_nonempty_llist_STAR_atomic_type_gbl_ -> (fun _ -> "reversed_separated_nonempty_llist_STAR_atomic_type_gbl_")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_option_layout_attr_ -> (fun _ -> "option_layout_attr_")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_mk_longident_mod_ext_longident___anonymous_46_ -> (fun _ -> "mk_longident_mod_ext_longident___anonymous_46_")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_local_strict_binding -> (fun _ -> "local_strict_binding")
  | MenhirInterpreter.N MenhirInterpreter.N_local_fun_binding -> (fun _ -> "local_fun_binding")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_layout_string -> (fun _ -> "layout_string")
  | MenhirInterpreter.N MenhirInterpreter.N_layout_attr -> (fun _ -> "layout_attr")
  | MenhirInterpreter.N MenhirInterpreter.N_layout_annotation -> (fun _ -> "layout_annotation")
  ...
  | MenhirInterpreter.N MenhirInterpreter.N_include_maybe_functor -> (fun _ -> "include_maybe_functor")
