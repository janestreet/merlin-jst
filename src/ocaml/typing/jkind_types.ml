...
<<<<<<< HEAD
  ...
  let less_or_equal t1 t2 : Misc_stdlib.Le_result.t =
    match t1, t2 with
  ...
  let le t1 t2 = Misc_stdlib.Le_result.is_le (less_or_equal t1 t2)
...
<<<<<<< HEAD
  ...
  let less_or_equal n1 n2 : Misc_stdlib.Le_result.t =
    match n1, n2 with
  ...
  let le n1 n2 = Misc_stdlib.Le_result.is_le (less_or_equal n1 n2)
